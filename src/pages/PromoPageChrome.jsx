...
const imageMap = {
  ...
  'bannerBaru': bannerBaru,
  'hadiah': hadiah,
  'putarRoda': putarRoda,
  'bannerQris': bannerQris
}

// Tag mapping untuk promo
const tagMap = {
  'HOT': 'HOT',
  'DAILY': 'DAILY',
  'WEEKLY': 'WEEKLY',
        ...
        <div className="p-4 space-y-2">
          ...
          >
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#2a2a2a] to-[#1a1a1a] flex items-center justify-center border border-[#3a3a3a]">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                <defs>
                  <linearGradient id="loginGradMenuPromo" x1="0%" y1="0%" x2="0%" y2="100%">
                    <stop offset="0%" stopColor="#FFFFFF"/>
                    <stop offset="50%" stopColor="#D0D0D0"/>
                    <stop offset="100%" stopColor="#A0A0A0"/>
                  </linearGradient>
                </defs>
                <path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4M10 17l5-5-5-5M15 12H3" stroke="url(#loginGradMenuPromo)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            >
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <linearGradient id="hamburgerGradPromo" x1="0%" y1="0%" x2="0%" y2="100%">
                    <stop offset="0%" stopColor="#FFFFFF"/>
                    <stop offset="50%" stopColor="#D0D0D0"/>
                    <stop offset="100%" stopColor="#A0A0A0"/>
                  </linearGradient>
                </defs>
                <path d="M3 6h18M3 12h18M3 18h18" stroke="url(#hamburgerGradPromo)" strokeWidth="2.5" strokeLinecap="round"/>
              </svg>
            </button>
      ...
      <div className="relative aspect-[16/9] overflow-hidden">
        <img 
          ...
          onError={(e) => {
            ...
            e.target.src = imageMap[fallbackKey] || welcomeBonus
          }}
        />
      ...
      try {
        ...
        const mappedData = data.map((promo, index) => {
          ...
          if (!image || image === '' || (image.startsWith('http') && !image.includes('localhost'))) {
            ...
            image = imageMap[imageKey] || welcomeBonus
          }
