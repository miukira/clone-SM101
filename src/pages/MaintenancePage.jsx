    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0a0a0a] to-[#1a1a1a] flex items-center justify-center p-4">
      <div className="max-w-lg w-full text-center">
        ...
        <div className="bg-gradient-to-b from-[#1a1a1a] to-[#0d0d0d] border border-[#333] rounded-2xl p-6 sm:p-8 mb-6">
          ...
          {estimatedTime && (
            <div className="bg-[#0a0a0a] border border-[#2a2a2a] rounded-xl p-4">
              <p className="text-xs text-[#606060] mb-1 tracking-wider">{t('maintenance.estDone')}</p>
        ...
        <div className="space-y-3">
          <p className="text-xs text-[#606060] tracking-wider">{t('maintenance.contactUs')}</p>
          <div className="flex justify-center gap-4">
            ...
            {contactLinks.testimoni && (
              <a
                href={contactLinks.testimoni}
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-4 py-2.5 bg-amber-600/20 border border-amber-500/30 rounded-lg text-amber-200 text-sm font-medium hover:bg-amber-600/30 transition-all"
              >
                <span className="w-5 h-5 text-center" aria-hidden>
                  ★
                </span>
                {t('contact.testimoni')}
              </a>
